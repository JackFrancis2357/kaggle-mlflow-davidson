...
def load_best_model_from_mlflow():
    ...
    current_experiment = dict(mlflow.get_experiment_by_name("Linear Regression Model"))
    experiment_id = current_experiment["experiment_id"]
    runs = client.search_runs(experiment_ids=experiment_id, order_by=["metrics.Validation_MAE ASC"], max_results=1)
    best_run = runs[0]
